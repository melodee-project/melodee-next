          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full border ${errors.username ? 'border-red-500' : 'border-gray-300'} rounded-md p-2`}
                required
              />
              ...
              <tr key={user.id || user.ID}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button
                    ...
                    className={`mr-2 ${user.is_admin || user.isAdmin || user.IsAdmin ? 'text-red-600' : 'text-green-600'}`}
                  >
